 ...
 * This class implements a remote object reference table which maps remote

 * object references to objects. Based on the code by Prof. Honda.

 * 

 * @author Prof. Honda, Yichen Wang
...
public class RORtbl {
	...
	HashMap<RemoteObjectRef, Object> rorMap;
	 ...
	 * Construct a new table and set the counter to zero

	 */

	public RORtbl() {

		rorMap = new HashMap<RemoteObjectRef, Object>();
	...
	public RemoteObjectRef addObj(String host, int port, Object o) {
		...
		RemoteObjectRef ror = new RemoteObjectRef(host, port, counter++, o
